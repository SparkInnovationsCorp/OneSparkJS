class IsometricGrid extends $1S.Renderer.Type.Render2D.Prop {
     ...
     onDraw(context) {
          ...
          //const topLeft = [100, 0];
          //const topRight = [300, 10];
          //const bottomRight = [200, 200];
          //const bottomLeft = [0, 200];

          ////const topLeft = [350.79846928731956, 338.8424613120418];
          ////const topRight = [655.4779330551985, 333.38569354690094];
          ////const bottomRight = [670.0000000000001, 468.49999999999926];
          ////const bottomLeft = [304.0055996671051, 476.36740549181104];

          //const wi = this.warpImage(grassImage.Image, topLeft, topRight, bottomLeft, bottomRight);

          //context.drawImage(wi, 800, 20);
